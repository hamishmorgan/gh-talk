...
**When to Use**: When reviewing someone else's PR
...
```
💡 Consider using a map here instead of array
...
`x` → `threadCount` would be clearer
```
...
**React to responses:**
```bash
gh talk react PRRC_xxx 👍  # Agree with fix
...
**Be vague:**
❌ "This looks wrong"
✅ "This will cause NPE when user is null - add null check"

**Block on style:**
❌ Request changes for minor style preferences
✅ Comment with "nit:" for minor suggestions

**Be negative:**
❌ "This code is terrible"
✅ "Consider refactoring this for clarity"

**Ignore context:**
❌ Perfect code in review
✅ Good enough + learning opportunity
...
- `pr-iterate` - For addressing review feedback
- `AGENTS.md` - Code standards to check against

---
Note: This content duplicated in .cursor/rules/pr-review.mdc for auto-loading
