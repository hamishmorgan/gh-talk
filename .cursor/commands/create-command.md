...
- ✅ **Keep it short** - 3-7 lines total
- ✅ **Reference the rule** - Point to `.cursor/rules/name.mdc`
- ✅ **Brief summary** - One sentence of what it covers
- ✅ **No frontmatter** - Commands don't use YAML frontmatter
- ✅ **.md extension** - Not .mdc
- ❌ **No full content** - That goes in the rule
...
---
Note: This content duplicated in .cursor/rules/create-command.mdc for auto-loading
